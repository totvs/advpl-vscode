...
export class ServersManagementView {

	constructor(context: vscode.ExtensionContext) {

		vscode.window.registerTreeDataProvider('serversManagement', new ServerProvider(vscode.workspace.rootPath));

		// const view = vscode.window.createTreeView('serversManagement', { treeDataProvider: new ServerProvider(vscode.workspace.rootPath), showCollapseAll: true });
